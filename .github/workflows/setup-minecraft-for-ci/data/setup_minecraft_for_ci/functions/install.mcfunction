...
setblock 0 2 0 structure_block{name: "minect:mcfunction-debugger/0", mode: CORNER}
setblock 0 0 0 structure_block{name: "minect:mcfunction-debugger/0", mode: LOAD}
