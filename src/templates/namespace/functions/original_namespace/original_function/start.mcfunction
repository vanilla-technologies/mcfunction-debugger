...
execute if score breakpoint namespace_global matches 0 as @e[type=area_effect_cloud,tag=namespace_selected_entity_marker] if score @s namespaceg_depth = current namespace_depth run kill @s
