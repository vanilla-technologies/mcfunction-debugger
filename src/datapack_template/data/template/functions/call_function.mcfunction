...
summon area_effect_cloud ~ ~ ~ {Duration: 2147483647, Tags: [-ns-_new, -ns-, -ns-_function_call, -ns-_-orig_ns-_-orig_fn-_-line_number-, -ns-_active], CustomName: '{"text":"-orig_ns-:-orig/fn-:-line_number-"}'}
