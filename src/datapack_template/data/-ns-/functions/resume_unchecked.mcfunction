...
execute if score resume_time_within_tick -ns-_global matches 0 run function -ns-:resume_immediate
# We are after age increment, but need to resume before age increment -> resume in schedule
execute if score resume_time_within_tick -ns-_global matches -1 run schedule function -ns-:resume_immediate 1t
