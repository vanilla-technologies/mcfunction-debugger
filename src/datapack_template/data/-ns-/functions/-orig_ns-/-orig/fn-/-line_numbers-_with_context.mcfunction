...
execute unless score @s -ns-_id matches 0 unless entity @e[tag=!-ns-_selected_entity_marker,tag=-ns-_tmp] run tellraw @a {"text": "Selected entity was killed!","color": "red"}
