...
execute if score aec_age test_time matches 1 run say [test: tag @s add success]
execute unless score aec_age test_time matches 1 run say [test: tag @s add failure]
