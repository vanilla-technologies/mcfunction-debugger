...
execute if score gametime2 test_global matches 10 run say [test: tag @s add success]
execute unless score gametime2 test_global matches 10 run say [test: tag @s add failure]
