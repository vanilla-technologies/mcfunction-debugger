...
execute if score aec_age test_time matches 0 run say [test: tag @s add success]
execute unless score aec_age test_time matches 0 run say [test: tag @s add failure]
