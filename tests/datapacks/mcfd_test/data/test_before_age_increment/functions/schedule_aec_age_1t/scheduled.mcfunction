...
execute if entity @e[type=area_effect_cloud,tag=test,limit=1] if score aec_age test_global matches 1 run say [test: summon area_effect_cloud ~ ~ ~ {CustomName: '{"text":"success"}'}]
