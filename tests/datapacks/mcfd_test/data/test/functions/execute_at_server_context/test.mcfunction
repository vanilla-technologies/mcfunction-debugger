...
execute if score position_sheep1 test_global matches 1 if score position_sheep2 test_global matches 1 run say [test: summon area_effect_cloud ~ ~ ~ {CustomName: '{"text":"success"}'}]
